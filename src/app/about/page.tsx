        ...
        <div className="max-w-3xl mx-auto">
          ...
          <Card className="mb-8">
            <CardHeader>
              ...
              <CardDescription>
                เรามุ่งมั่นที่จะสร้างเว็บแอปพลิเคชันที่มีประสิทธิภาพสูง สวยงาม
                และใช้งานง่าย
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <p className="text-slate-600 leading-relaxed">
                ...
                ด้วยการใช้
                Next.jsเราสร้างสรรค์ประสบการณ์การใช้งานที่ราบรื่นและน่าประทับใจสำหรับผู้ใช้ของเรา
              </p>
              <p className="text-slate-600 leading-relaxed">
                การใช้ Tailwind CSS และ shadcn/ui ช่วยให้เราสามารถพัฒนา UI
                ที่สวยงามและตอบสนองได้อย่างรวดเร็ว
